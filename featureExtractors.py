...
## It returns the following features: pac-man position ("posX", "posY"), 
## distance to the closest food ("FoodX", "FoodY") and distance to the closest ghost ("IncGhostX", "IncGhostY")
  def getFeatures(self, state):
    # extract the grid of food and wall locations and get the ghost locations
    food = state.getFood()
    walls = state.getWalls()
